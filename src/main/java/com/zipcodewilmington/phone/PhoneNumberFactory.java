...
public final class PhoneNumberFactory {
    ...
    public static PhoneNumber createRandomPhoneNumber() {
        int areaCode = (int)Math.floor(Math.random() * (888 - 100 + 1) + 100);
        int centralOfficeCode = (int)Math.floor(Math.random()* (888-100+1) + 100);
        int phoneLineCode = (int)Math.floor(Math.random() * (8888 + 1));
